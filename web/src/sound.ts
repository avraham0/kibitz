...
// Preload one element per sound; cloning lets rapid repeats overlap instead of
// cutting each other off. Guarded so it no-ops in non-browser (test) envs.
